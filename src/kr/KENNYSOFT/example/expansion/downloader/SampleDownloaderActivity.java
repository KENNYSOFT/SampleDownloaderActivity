...
import kr.KENNYSOFT.example.expansion.downloader.R;
    ...
    private static final XAPKFile[] xAPKS = {
            new XAPKFile(
                    ...
                    7, // the version of the APK that the file was uploaded
                       // against
                    67934L // the length of the file in bytes
            ),
            new XAPKFile(
                    false, // false signifies a patch file
                    7, // the version of the APK that the patch file was uploaded
                       // against
                    10389L // the length of the patch file in bytes
            )            
    };
